                ...
                <form id="loginForm" onSubmit={handleSubmit}>
                    ...
                    <div className="relative mb-6">
                        <input
                            ...
                            placeholder="Email"
                            required
                            className="w-full py-2 px-10 bg-white bg-opacity-20 text-white rounded-md outline-none transition-all duration-300 focus:bg-opacity-30 border focus:border-orange-500"
                            value={email}
